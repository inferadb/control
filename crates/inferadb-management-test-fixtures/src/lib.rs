...
//!
//! ```rust,no_run
//! use inferadb_management_test_fixtures::{create_test_state, create_test_app, register_user};
//! use inferadb_management_core::IdGenerator;
//!
//! #[tokio::test]
//! async fn my_test() {
...
use inferadb_management_api::{AppState, create_router_with_state};
...
///
/// ```rust,no_run
/// use inferadb_management_test_fixtures::create_test_state;
///
/// let state = create_test_state();
...
///
/// ```rust,no_run
/// use inferadb_management_test_fixtures::{create_test_state, create_test_app};
///
/// let state = create_test_state();
/// let app = create_test_app(state);
...
///
/// ```rust,no_run
/// use inferadb_management_test_fixtures::extract_session_cookie;
