...
async fn test_deploy_schema_auto_version_increment() {
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!("/v1/organizations/{}/vaults/{}/schemas", org_id, vault_id))
                .header("cookie", format!("infera_session={}", session))
                .header("content-type", "application/json")
                .body(Body::from(
                    json!({
...
async fn test_get_schema_by_version() {
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(format!("/v1/organizations/{}/vaults/{}/schemas/1.0.0", org_id, vault_id))
                .header("cookie", format!("infera_session={}", session))
                .body(Body::empty())
                .unwrap(),
        )
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!(
                    "/v1/organizations/{}/vaults/{}/schemas/1.0.0/activate",
                    org_id, vault_id
                ))
                .header("cookie", format!("infera_session={}", session))
                .body(Body::empty())
...
async fn test_get_current_schema() {
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(format!("/v1/organizations/{}/vaults/{}/schemas/current", org_id, vault_id))
                .header("cookie", format!("infera_session={}", session))
                .body(Body::empty())
                .unwrap(),
        )
...
async fn test_rollback_schema() {
    ...
    app.clone()
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!(
                    "/v1/organizations/{}/vaults/{}/schemas/1.1.0/activate",
                    org_id, vault_id
                ))
                .header("cookie", format!("infera_session={}", session))
                .body(Body::empty())
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!("/v1/organizations/{}/vaults/{}/schemas/rollback", org_id, vault_id))
                .header("cookie", format!("infera_session={}", session))
                .header("content-type", "application/json")
                .body(Body::from(
                    json!({
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(format!(
                    "/v1/organizations/{}/vaults/{}/schemas/diff?from=1.0.0&to=1.1.0",
                    org_id, vault_id
                ))
                .header("cookie", format!("infera_session={}", session))
                .body(Body::empty())
...
async fn test_get_nonexistent_schema_returns_404() {
    ...
    let response = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(format!("/v1/organizations/{}/vaults/{}/schemas/99.99.99", org_id, vault_id))
                .header("cookie", format!("infera_session={}", session))
                .body(Body::empty())
                .unwrap(),
        )
