...
use inferadb_management_core::{Error as CoreError, IdGenerator, RepositoryContext};
...
pub async fn list_teams(
    ...
    let pagination_meta = inferadb_management_types::PaginationMeta::from_total(
        total,
        params.offset,
        params.limit,
        teams.len(),
...
pub async fn update_team(
    ...
    let is_admin_or_owner = org_ctx.member.role
        == inferadb_management_core::OrganizationRole::Admin
        || org_ctx.member.role == inferadb_management_core::OrganizationRole::Owner;
